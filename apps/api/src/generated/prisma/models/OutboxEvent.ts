...
export type OutboxEventWhereInput = {
  ...
  lastAttemptAt?: Prisma.DateTimeNullableFilter<"OutboxEvent"> | Date | string | null
...
export type OutboxEventScalarWhereWithAggregatesInput = {
  ...
  lastAttemptAt?: Prisma.DateTimeNullableWithAggregatesFilter<"OutboxEvent"> | Date | string | null
...
export type OutboxEventOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "topic" | "payload" | "published" | "retryCount" | "lastError" | "lastAttemptAt" | "createdAt", ExtArgs["result"]["outboxEvent"]>
...
export interface OutboxEventFieldRefs {
  ...
  readonly lastAttemptAt: Prisma.FieldRef<"OutboxEvent", 'DateTime'>
